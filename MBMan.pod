...
Die Voreinstellung für diesen Schalter ist '0', also 'nicht löschen'. Auf die
...
Überprüft, ob das Limit einer Mailbox überschritten wurde. Das
voreingestellte Limit beträgt 80%. Das Limit kann vorher in der Methode 'new'
...
Die Verbindung zum IMAP-Server wird abgebaut. Die bisher gesammelten Daten
bleiben jedoch erhalten; ein Login ist sofort ohne Angabe der Zugangsdaten
möglich.
...
Die letzte geladene Nachricht wird innerhalb der Datenbank gespeichert.
...
Gib die Mailboxen des aktuellen Benutzers als ARRAY_REF zurück.
...
Tip: Mit einem gängigen 'DataDumper'-Modul können die Daten-Felder
